...
namespace GestionQR.Controllers
{
    public class PuestosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Descripcion,Funciones")] Puesto puesto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Descripcion,Funciones")] Puesto puesto)
        {
            if (ModelState.IsValid)
            {
