...
namespace GestionQR.Controllers.Administrador
{
    public class DepartamentosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,tipo_departamento,encargado_departamento,Nombre_Departamento")] Departamentos departamentos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,tipo_departamento,encargado_departamento,Nombre_Departamento")] Departamentos departamentos)
        {
            if (ModelState.IsValid)
            {
